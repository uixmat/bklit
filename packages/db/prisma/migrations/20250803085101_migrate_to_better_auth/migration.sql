/*
  ...
  - You are about to drop the `SubscriptionPlanBenefit` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "SubscriptionPlanBenefit" DROP CONSTRAINT "SubscriptionPlanBenefit_planId_fkey";
...
-- DropTable
DROP TABLE "SubscriptionPlanBenefit";
